...
class PlayerProfile extends StatelessWidget {
  final playerDocument;

  const PlayerProfile({Key? key, required this.playerDocument})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    final playerData = playerDocument.data() as Map<String, dynamic>;
    //getx controller
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              title: Text(playerData['email']),
            ),
            const Divider(),
            ListTile(
                leading: const Icon(Icons.phone),
                title: Text(playerData['phoneNumber'])),
            const Divider(),
            ListTile(
              leading: const Icon(Icons.location_on),
              title: Text(playerData['city']),
            ),
            const Divider(),
            ListTile(
              leading: const Icon(FontAwesomeIcons.venusMars),
              title: Text(playerData['gender']),
            ),
            const Divider(),
            ListTile(
              leading: const Icon(FontAwesomeIcons.userTie),
              title: Text(playerData['profession']),
            ),
            Container(
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemCount: vidcontroller.videolist
                        .where((e) => e.email == playerData['email'])
                        .length,
                    gridDelegate:
